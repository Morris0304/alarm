    ...
    const getWeather =() => {
        ...
        .then(results => {
            setInfo({
                ...
                time5 : results.list[8].dt_txt,
                time6 : results.list[9].dt_txt,
                time7 : results.list[10].dt_txt,
                temp1 : results.list[3].main.temp,
                temp2 : results.list[4].main.temp,
                temp3 : results.list[5].main.temp,
                temp4 : results.list[6].main.temp,
                temp5 : results.list[7].main.temp,
                temp6 : results.list[8].main.temp,
                temp7 : results.list[9].main.temp,
                temp8 : results.list[10].main.temp,
                ...
                icon1 : results.list[3].weather[0].icon,
                icon2 : results.list[4].weather[0].icon,
                icon3 : results.list[5].weather[0].icon,
                icon4 : results.list[6].weather[0].icon,
                icon5 : results.list[7].weather[0].icon,
                icon6 : results.list[8].weather[0].icon,
                icon7 : results.list[9].weather[0].icon,
                icon8 : results.list[10].weather[0].icon,
            })
        })
    }
